...
Potree.PointCloudQuadtreeGeometry = class PointCloudQuadtreeGeometry{
...
Potree.PointCloudQuadtreeGeometryNode = class PointCloudQuadtreeGeometryNode extends Potree.PointCloudTreeNode{
	...
	loadHierachyThenPoints(){
		...
		let callback = function (node, hbuffer) {
			...
			for (let i = 0; i < decoded.length; i++) {
				...
				let boundingBox = Potree.POCLoader.createChildAABBQuad(parentNode.boundingBox, index);

				let currentNode = new Potree.PointCloudQuadtreeGeometryNode(name, pco, boundingBox);
